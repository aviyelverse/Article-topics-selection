...
toc: false
layout: post
description: "Mage is an open-source code pipelines."
categories: [MageAI]
title: "Mage-ai"
         ...
         <div class="col-md-6 offset-md-3 wrap-layoutbox-box">
            <div class="card card-shadow border-0  mb-4">
               <div class="card-body d-flex">
                  ...
                  <div class="">
                     <h5 class="font-weight-medium"><a href="/Article-topics-selection/beginner-level-mage-ai" class="linking">eginner level topics.</a></h5>
                  </div>
               </div>
            </div>
         </div>
